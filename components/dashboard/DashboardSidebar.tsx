...
const menuItems: SidebarItem[] = [
  ...
  { id: 'tutorial', label: 'Tutorial', icon: <img src="https://hdnfltv.com/image/nitimages/pasted_1770763376612.webp" alt="Tutorial" className="w-5 h-5 object-contain" /> },
    { id: 'incomplete_orders', label: 'Incomplete Orders', icon: <img src="https://hdnfltv.com/image/nitimages/pasted_1770763376612.webp" alt="Incomplete Orders" className="w-5 h-5 object-contain" /> },
];
    ...
    <nav className={`space-y-1 ${className}`}>
      ...
      {systemMenuItems.length > 0 && (
       ...
       <div className="pt-4 border-t border-gray-100 dark:border-gray-700">
        <button
          onClick={() => onNavigate?.('incomplete_orders')}
        ...
        >
          ...
          <span className="text-sm font-medium">Incomplete Orders</span>
        </button>
      </div>
