...
import useComingSoon from '../components/NewComponentMentItem';
...
const AdminSettingsNew: React.FC<AdminSettingsNewProps> = ({ onNavigate, currentUser, onUpdateProfile, activeTenant }) => {
  ...
  const { showComingSoon, ComingSoonPopup } = useComingSoon() as unknown as { showComingSoon: (title: string) => void; ComingSoonPopup: React.ReactNode };
